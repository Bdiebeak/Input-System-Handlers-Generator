...
namespace Bdiebeak.InputSystemGeneration
{
    ...
    public partial class InputActionsReaderTemplate : TemplateGenerator
    {
        ...
        public virtual string TransformText()
        {
            ...
            Write("using Bdiebeak.InputSystemGeneration;\r\n");
            ...
            Write("\t\t{\r\n");
            Write("\t\t\tvar requiredActionName = actionValue.ToString();\r\n");
            Write("\t\t\tvar actionToAdd = _playerInput.actions.FirstOrDefault(x => string.Equals(x.name.ToCamelCase(), requiredActionName));\r\n");
            Write("\t\t\tif (actionToAdd == null)\r\n");
            Write("\t\t\t{\r\n");
            Write("\t\t\t\tDebug.LogError($\"Can't find required \\\"{requiredActionName}\\\" Action in Map.\");\r\n");
            Write("\t\t\t\tcontinue;\r\n");
            Write("\t\t\t}\r\n");
            Write("\r\n");
            Write("\t\t\t_inputActions.Add(actionValue, actionToAdd);\r\n");
            Write("\t\t}\r\n");
            Write("\t}\r\n\r\n");
